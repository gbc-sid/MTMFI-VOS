...
class Parameters:
    ...
    def __init__(self, weights, seg, fast=False, device="cuda:0"):
        ...
        if fast:
            ...
            self.init_iters = (5, 10, 10, 10, 10) # (5, 10, 10, 10, 10)
            self.update_iters = (10,) # (10,)
        ...
        # Davis数据集channels=64, memory_size=80
    ...
    def get_model(self):
        ...
        elif self.seg_config == 'cbam':
            refiner = seg_cbam(self.disc_params_l4.out_channels, p.nchannels, refinement_layers_channels, p.use_batch_norm)
...
if __name__ == '__main__':
    ...
    paths = dict(
        models="/root/VOS/frtm-vos-otherlayer/weights",  # The .pth files should be here
        davis="/root/VOS/Davis_data/DAVIS-2017-trainval-480p",  # DAVIS dataset root
        yt2018="/root/VOS/Youtube-data",  # YouTubeVOS 2018 root
        output="/root/VOS/frtm-vos-otherlayer/results",  # Output path
    )
    # paths = dict(
    ...
    args_parser.add_argument('--seg', type=str, default="initial", choices=["initial", "bise", "cbam"],
